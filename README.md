...
```
```
 git clone https://github.com/darkhunter141/IP-Master
```
```
 cd IP-Master
```
...
```
pkg install python2 && git clone https://github.com/darkhunter141/IP-Master && cd IP-Master && python2 iptool.py
```
<br>
